...
@interface KCS_FMResultSet : NSObject {
    KCS_FMDatabase          *_parentDB;
    KCS_FMStatement         *_statement;
...
@property (atomic, retain) KCS_FMStatement *statement;
